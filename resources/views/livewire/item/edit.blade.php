        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="col-md-12">
                        <div class="mb-3">
                            <div id="qr-reader2" style="width:100%" wire:ignore></div>
                            ...
                            <input type="text" class="form-control @error('barcode_number') is-invalid @enderror"
                                name="barcode_number" id="barcode_number2" wire:model.defer="barcode_number">
    ...
    docReady(function() {
        ...
        function onScanSuccess(decodedText, decodedResult) {
            if (decodedText !== lastResult) {
                ...
                $('#barcode_number2').val(decodedText);
                if ($('#barcode_number2').val(decodedText) != null) {
